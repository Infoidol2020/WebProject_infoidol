...
const Affiliate = (props) => {
    ...
    return (
        <div>
            <Navbar/>
            <Sidebar/>
            <section className="Affiliate_Affiliate">
                <div className="Affiliate_Header">
                ...
                <div className="Affiliate_AffiliateImg">
                    <img src={AffiliateImg} alt="Broken-img" />
                </div>

                <div className="Affiliate_Details">
                <>
                <ul>  
                    <li>Ads on Carousel for 3 times a month at Targeted areaa.</li>  
                    <li>Benefits of getting the Updated Features.</li>  
                    <li> Affiliate Badge. </li>  
                    <li> Gets 50% of money by Selling Official Creator, Official update and Business Update.</li> 
                    <li>Monetization Enable.</li>  
                    <li>Certificate of Official Affiliate Partner from Infoidol.</li>  
