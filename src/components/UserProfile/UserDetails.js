...
const UserDetails = (props) => {
    // console.log('propswess userDetails', props.data)
    ...
    return (
            ...
            <div class="modal-body" >
                    ...
                    <div style={{display: 'flex', }}>
                        <div style={{marginLeft: '2vw', border: 'solid 1px #dadada', padding: '1rem'}}>
                            ...
                            <div>
                                <input ref={editProfileName} autocomplete="off"  onChange={(e) => handleChangeUserDetails(e)} style={{width: '15vw', height:'5vh'}} id="name" 
                                placeholder={profileInfo && profileInfo.name} name="profileName" type="text"/>
                            </div>
                            {/* <div>
                        ...
                        <div style={{marginLeft: '5vw',}}>
                            ...
                            <div style={{textAlign: 'center'}}>
                                <LazyLoadImage placeholder={<div><img src={miniLoader} /></div>}  src={profileInfo &&  profileInfo.profile_pic} style={{borderRadius: '50%',border: 'solid 2px #333', height: '12rem', width: '12rem'}}/>
                            </div>
        ...
        <div className="user-details-container">
            <div className="user-details-profile_pic-container" style={{textAlign :'center', marginTop: '15vh'}}>
            <LazyLoadImage 
            className="user-details-profile_pic"
            placeholder={<div><img src={miniLoader} /></div>} src={profileInfo && profileInfo.profile_pic} />
            </div>
            <div>
