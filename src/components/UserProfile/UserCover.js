...
// console.log('proooo', props.userProfileFromAPI.uploadCoverPic.uploadCoverPicApi.uploadCoverPicSuccess)
    return (
        <div className="UserCover-upload-profilepic-modal"> 
            ...
            <>
                ...
                <div class="modal-dialog" role="document">
                    ...
                    <div class="modal-header">
                        ...
                        {
                            props.userProfileFromAPI.uploadCoverPic.uploadCoverPicApi.uploadCoverPicSuccess && 
                            <div className="uploadCoverPicSuccess" style={{display: 'flex', alignItems: 'center', 
            ...
            <div 
            className="User-cover-pic-container"
            >
                    <LazyLoadImage 
                    className="User-cover-pic"
                    placeholder={<div><img src={miniLoader} /></div>} 
                    src ={props.userCoverPic} 
                ...
                </div>
                {
                    ...
                    <div 
                    className="User-cover-pic-upload"
                    title="upload cover pic" style={{position: 'absolute', top: '10%', left: '95%', transform: 'translate(-50%, 50%)', 
