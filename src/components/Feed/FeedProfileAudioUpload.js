...
const FeedProfileAudioUpload = () => {
    ...
    const onFileChange = (e) => {
        ...
        // console.log('fields.musicfile', fields.musicfile);
        // setFileds({...fields,
    ...
    const onImageChange = (e) => {
     ...
     const handleSubmit = (e) => {
        ...
        formData.append('music_file', fields.musicfile);
        ...
        axios.post('https://infoidol.com/admin/WebApi/upload_music',formData).then( response => {
                ...
                <div class="modal-body">
                    <form onSubmit={handleSubmit}>
                        ...
                        <div style={{display: 'flex'}}>
                            ...
                            <div>
                                <input name="audiofile" type="file" accept="audio/*" onChange = { (e) => onFileChange(e) } />
                            </div>
                        </div>
                        <div style={{display: 'flex'}}>
                            <div>
...
export default FeedProfileAudioUpload
