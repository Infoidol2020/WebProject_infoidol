...
const TermsAndCondition = () => {
    return (
        <div>
            ...
            <h2 className="termAndCoondition"><strong>Terms and Conditions</strong></h2>

<p>Welcome to Infoidol!</p>

<p>These terms and conditions outline the rules and regulations for the use of Infoidol's Website, located at www.infoidol.com.</p>

<p>By accessing this website we assume you accept these terms and conditions. Do not continue to use 
Infoidol if you do not agree to take all of the terms and conditions stated on this page.</p>
...
in the singular, plural, capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.</p>

<h3><strong>Cookies</strong></h3>

<p>We employ the use of cookies. By accessing Infoidol, you agreed to use cookies in agreement with 
the Infoidol's Privacy Policy. </p>
...
<p>Unless otherwise stated, Infoidol and/or its licensors own the intellectual property rights for 
all material on Infoidol. All intellectual property rights are reserved. You may access this from 
Infoidol for your own personal use subjected to restrictions set in these terms and conditions.</p>

<p>You must not:</p>
<ul>
    <li>Republish material from Infoidol</li>
    <li>Sell, rent or sub-license material from Infoidol</li>
    <li>Reproduce, duplicate or copy material from Infoidol</li>
    <li>Redistribute content from Infoidol</li>
</ul>

<p>Parts of this website offer an opportunity for users to post and exchange opinions and information
 in certain areas of the website. Infoidol does not filter, edit, publish or review Comments prior to
 their presence on the website. Comments do not reflect the views and opinions of Infoidol,
its agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and opinions.
 To the extent permitted by applicable laws, Infoidol shall not be liable for the Comments or for any liability, 
...
<p>Infoidol reserves the right to monitor all Comments and to remove any Comments which can be considered inappropriate,
...
<p>You hereby grant Infoidol a non-exclusive license to use, reproduce, edit and authorize others to use, 
...
(a) is not in any way deceptive; (b) does not falsely imply sponsorship, endorsement or approval of 
the linking party and its products and/or services; and (c) fits within the context of the linking party’s site.</p>
...
(c) the benefit to us from the visibility of the hyperlink compensates the absence of Infoidol; and 
...
<p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our website,
 you must inform us by sending an e-mail to Infoidol. Please include your name, your organization name, 
...
<p>No use of Infoidol's logo or other artwork will be allowed for linking absent a trademark license agreement.</p>
...
and inform us any moment. We will consider requests to remove links but we are not obligated to or
...
<p>We do not ensure that the information on this website is correct, we do not warrant its completeness
 or accuracy; nor do we promise to ensure that the website remains available or that the material on the
