...
const VideoPage = (props) => {
    ...
    const allVideos = props.AllVideoPage
    ...
    const loadMoreVideos = () => {
        let offset = sessionStorage.getItem('videoPageOffset')
        let newOffset = parseInt(offset) + 10
        sessionStorage.setItem('videoPageOffset', newOffset)
        props.hitAllVideoPageAPI(newOffset, sessionStorage.getItem('video-page-type'))
    ...
    return (
        ...
        <div style={{textAlign: 'center'}}>
            {
                allVideos.map((videoElement, videoIndex) => {
                    return(
                        <>
                        ...
                        margin: '1rem', 
                            ...
                            <div style={{width: '15vw', height: '15vh'}}>
                                ...
                                <LazyLoadImage style={{width: '14vw', height: '7vw', margin: '0.5rem', objectFit: 'cover', borderRadius: '10px'}} src={videoElement.video_thumbnail_link} placeholder={<div><img src={miniLoader} /></div>} />
                                :
                                <LazyLoadImage style={{width: '14vw', height: '7vw', margin: '0.5rem', objectFit: 'cover', borderRadius: '10px'}} src={videoElement.cat_image_link} placeholder={<div><img src={miniLoader} /></div>} />
                                }
                            </div>
            ...
            {
                sessionStorage.getItem('videoPageOffset') != '0' &&
                <div 
                onClick={prevVideos}
